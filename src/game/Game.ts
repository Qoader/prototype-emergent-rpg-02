...
export class Game {
  ...
  private updateDetail(display: ChunkDisplay, detail: Detail) {
    ...
    for (const road of composeRoads(candidates)) this.addRoad(roadLayer, road.points, road.width, road.color);
