...
describe('tile debug info', () => {
  ...
  it('reports exact generated and streamed features without duplicates', () => {
    ...
    const chunk = {
      cx: 0, cy: 0, tiles: [],
      settlements: [{ id: 'town', x: 1, y: 1, type: 'town' as const, radius: 2, populationClass: 1, footprint: { width: 4, height: 4, rotation: 0 }, anchors: [{ id: 'market', type: 'market' as const, x: 1, y: 1 }], accessPoints: [] }],
